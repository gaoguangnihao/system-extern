...
BOOTIMG_HDR_FMT = "<8c 10I 16c 512c 8I 1024c I Q I"
...
class Sign(object):
    ...
    def set_context(self):
        ...
        cert_out = os.path.join(self.context['out_path'], "cert", img_name)
        print 'dhcui mkimage_config ' + mkimage_config 
        print 'dhcui img_name ' + img_name
        ...
        if self.args['type'] == "cert1md":
            ...
            sig_path = os.path.join(self.context['out'], "sig")
    ...
    def __create_out_dir(self, path):
        ...
        print "Create dir dhcui out:" + dir_path
    ...
    def __create_abs_dir(self, path):
        ...
        print "Create dir dhcui abs:" + dir_path
    ...
    def __create_folder(self):
        ...
        print "__create_folder dhcui :" + mkimage_config_out 
        print 'bin path ' + bin_path
        print 'bin path ' + self.args['type']
    ...
    def gen_cert2(self):
        ...
        print "sign dhcui bin_number:" + str(len(img_array))
        #Get hash from image
        i = 0
        img_list_end = 0
        for img in img_array:
            ...
            if is_raw == 1 or is_boot == 1 or is_md == 1 or is_md == 2 or is_dtbo:
                ...
                if img_name_array[i] == img_name:
                    ...
                    print "gen_cert2 dhcui " + cert2_config_out
                    print "gen_cert2 dhcui " + cert_privk
                    print "gen_cert2 dhcui " + cert2_name
...
def check_is_boot(img_file):
    ...
    if cmp(magic_str, BOOTIMG_HDR_MAGIC) == 0:
        ...
        img_size = (kernel_size + ramdisk_size + hdr_size + dtbo_size + (16 - 1)) / 16 * 16
...
def add_mkimg_header(cert_name, img_list_end, img_type, img_name, context):
    ...
    print "add_mkimg_header  dhcui " + cert_name
    print "add_mkimg_header  dhcui " + mkimage_config_out
